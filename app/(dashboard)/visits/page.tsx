        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 text-xs">
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            <span className="font-bold text-slate-800 block mb-1">
              {t('1. LMS & Infrastructure')}
            </span>
            <p className="text-slate-500">
              {t('Verify 24/7 server uptime, disaster recovery, and student bandwidth access.')}
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            <span className="font-bold text-slate-800 block mb-1">
              {t('2. Faculty & Student Ratio')}
            </span>
            <p className="text-slate-500">
              {t('Inspect full-time dedicated ODL course coordinators and tutoring records.')}
            </p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            <span className="font-bold text-slate-800 block mb-1">
              {t('3. Examination Security')}
            </span>
            <p className="text-slate-500">
              {t('Review biometric student verification and proctored examination center logs.')}
            </p>
          </div>
        </div>
      </div>
