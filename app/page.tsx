      ...
      <header className="border-b border-slate-200/80 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
          <div className="text-lg sm:text-xl font-extrabold tracking-tight text-blue-900 flex items-center gap-2">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-blue-800 font-bold text-white text-sm">
              ODL
            </span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <LanguageToggle />
            <Link href="/login" className="btn-secondary px-3 py-2 text-xs sm:px-5 sm:text-sm font-semibold">
              {t('Sign in')}
            </Link>
            <Link
              href="/signup"
              className="btn-primary px-3 py-2 text-xs sm:px-5 sm:text-sm font-semibold shadow-md shadow-blue-700/20"
            >
